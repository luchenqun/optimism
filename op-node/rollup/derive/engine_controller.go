...
func (e *EngineController) ConfirmPayload(ctx context.Context, sequencerConductor conductor.SequencerConductor) (out *eth.ExecutionPayload, errTyp BlockInsertionErrType, err error) {
	if e.buildingID == (eth.PayloadID{}) {
	...
	payload, errTyp, err := confirmPayload(ctx, e.log, e.engine, fc, e.buildingID, updateSafe, sequencerConductor)
	if err != nil {
