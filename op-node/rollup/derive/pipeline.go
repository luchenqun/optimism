...
type EngineQueueStage interface {
	HighestUnsafeBlock() eth.L2BlockRef
...
// HighestUnsafeBlock returns the highest queued unsafe block
func (dp *DerivationPipeline) HighestUnsafeBlock() eth.L2BlockRef {
	return dp.eng.HighestUnsafeBlock()
}
